    ...
    reducers: {
        ...
        setShow: (state, action) => {
            if (action.payload === "volume") {
                ...
                if ([10, 25, 50].indexOf(state.limit) === -1) {
            ...
            action.payload.map((asset) => {
                ...
                if (asset.metrics) {
                    ...
                    if (asset.metrics.market_data) {
                        ...
                        if (asset.metrics.market_data.ohlcv_last_24_hour) {
                            assetData.volume1D = asset.metrics.market_data.ohlcv_last_24_hour.volume || 0;
                        };
