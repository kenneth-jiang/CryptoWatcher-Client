                    ...
                    <React.Fragment key={coin + index}>
                        <Grid item xs={2}>
                            <Card
                                ...
                                onClick={() => history.push("/coins/" + coin.symbol.toLowerCase())}
                            >
                                <CardActionArea style={{ padding: "16px 16px 0px 16px" }}>
                                    ...
                                    <Grid container>
                                        ...
                                        <Grid item xs={6} style={{ textAlign: "right" }}>
                                            ...
                                            <br />
                                            <strong>{helpers.abbreviateLargeCurrencyNums(coin.marketCap)}</strong>
                                            <br />
                                            <strong>{helpers.abbreviateLargeCurrencyNums(coin.volume1d)}</strong>
                                        </Grid>
                                    </Grid>
                                    <ReactApexChart
