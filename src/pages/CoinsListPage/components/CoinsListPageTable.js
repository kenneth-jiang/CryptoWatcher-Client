                                ...
                                >
                                    ...
                                    <TableCell style={{ textAlign: "left", width: "275px", whiteSpace: "nowrap", border: "1px solid #ddd" }}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={9}>
                                                <span style={{ cursor: "pointer" }} onClick={() => history.push("/coins/" + coinRowData.name.toLowerCase())}>
            ...
            <div style={{ display: "flex", padding: "16px" }}>
                ...
                <div style={{ width: "33%", textAlign: "right" }}>
                    <ButtonGroup color="primary">
                        ...
                        {[props.tablePage - 2, props.tablePage - 1, props.tablePage, props.tablePage + 1, props.tablePage + 2].map((pageEle) => {
